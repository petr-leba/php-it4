...
<body>
    <form action="" method="post">
        ...
        <input type="submit" name="odeber" value="Odeber">
...
if(isset($_POST['odeber'])){
    $sql = "DELETE FROM customers WHERE CustomerID = {$_POST['CustomerID']} LIMIT 1;";
    $mysqli->query($sql);
    echo $sql;
}
...
while ($row = $result->fetch_assoc()) {
    printf("<tr><td><input type='radio' name='CustomerID' value='{$row["CustomerID"]}'></td>"
